...
#include "AP_InertialSensor_H3LIS331DL.h"

extern const AP_HAL::HAL &hal;

#define H3LIS331DL_WHOAMI   0x32


//////////////////////////////////////////
// H3LIS331DL Accel/Magneto Registers   //
//////////////////////////////////////////

#define CTRL_REG1                                     0x20
#   define CTRL_REG1_PM_POWERDOWN_DFLT          (0x0 << 5)
#   define CTRL_REG1_PM_NORMAL_ODR              (0x1 << 5)
#   define CTRL_REG1_PM_500mHz                  (0x2 << 5)
#   define CTRL_REG1_PM_LOWPOWER_1Hz            (0x3 << 5)
#   define CTRL_REG1_PM_LOWPOWER_2Hz            (0x4 << 5)
#   define CTRL_REG1_PM_LOWPOWER_5Hz            (0x5 << 5)
#   define CTRL_REG1_PM_LOWPOWER_10Hz           (0x6 << 5)
#   define CTRL_REG1_DR_50Hz_DFLT               (0x0 << 3)
#   define CTRL_REG1_DR_100Hz                   (0x1 << 3)
#   define CTRL_REG1_DR_400Hz                   (0x2 << 3)
#   define CTRL_REG1_DR_1000Hz                  (0x3 << 3)
#   define CTRL_REG1_ZDISABLED                  (0x0 << 2)
#   define CTRL_REG1_ZEN_DFLT                   (0x1 << 2)
#   define CTRL_REG1_YDISABLED                  (0x0 << 1)
#   define CTRL_REG1_YEN_DFLT                   (0x1 << 1)
#   define CTRL_REG1_XDISABLED                  (0x0 << 0)
#   define CTRL_REG1_XEN_DFLT                   (0x1 << 0)
#define CTRL_REG2_XM                                  0x21
#   define CTRL_REG2_BOOT_NORMAL_DFLT           (0x0 << 7)
#   define CTRL_REG2_BOOT_MEMCONTENT            (0x1 << 7)
#   define CTRL_REG2_HPM_NORMAL_DFLT            (0x0 << 5)
#   define CTRL_REG2_HPM_REFERENCE              (0x1 << 5)
#   define CTRL_REG2_HPM_NORMAL                 (0x2 << 5)
#   define CTRL_REG2_FDS_BYPASSIFDATA_DFLT      (0x0 << 4)
#   define CTRL_REG2_FDS_OUTPUTIFDATA           (0x0 << 4)
#   define CTRL_REG2_HPEN2_BYPASS_DFLT          (0x0 << 3)
#   define CTRL_REG2_HPEN2_ENABLE               (0x1 << 3)
#   define CTRL_REG2_HPEN1_BYPASS_DFLT          (0x0 << 2)
#   define CTRL_REG2_HPEN1_ENABLE               (0x1 << 2)
#   define CTRL_REG2_HPCF_8_DFLT                (0x0 << 0)
#   define CTRL_REG2_HPCF_16                    (0x1 << 0)
#   define CTRL_REG2_HPCF_32                    (0x2 << 0)
#   define CTRL_REG2_HPCF_64                    (0x3 << 0)
#define CTRL_REG3                                     0x22
#   define CTRL_REG3_IHL_ACTIVEHIGH_DFLT        (0x0 << 7)
#   define CTRL_REG3_IHL_ACTIVELOW              (0x1 << 7)
#   define CTRL_REG3_PP_OD_PUSHPULL_DFLT        (0x0 << 6)
#   define CTRL_REG3_PP_OD_OPENDRAIN            (0x1 << 6)
#   define CTRL_REG3_LIR2_NOTLATCHED_DFLT       (0x0 << 5)
#   define CTRL_REG3_LIR2_LATCHED               (0x1 << 5)
#   define CTRL_REG3_I2_CFG_INT2SOURCE_DFLT     (0x0 << 3)
#   define CTRL_REG3_I2_CFG_INT1INT2SOURCE      (0x1 << 3)
#   define CTRL_REG3_I2_CFG_DRDY                (0x2 << 3)
#   define CTRL_REG3_I2_CFG_BOOTRUN             (0x3 << 3)
#   define CTRL_REG3_LIR1_NOTLATCHED_DFLT       (0x0 << 2)
#   define CTRL_REG3_LIR1_LATCHED               (0x1 << 2)
#   define CTRL_REG3_I1_CFG_INT1SOURCE_DFLT     (0x0 << 0)
#   define CTRL_REG3_I1_CFG_INT1INT2SOURCE      (0x1 << 0)
#   define CTRL_REG3_I1_CFG_DRDY                (0x2 << 0)
#   define CTRL_REG3_I1_CFG_BOOTRUN             (0x3 << 0)
#define CTRL_REG4                                     0x23
#   define CTRL_REG4_BDU_CONTINUOUS_DFLT        (0x0 << 7)
#   define CTRL_REG4_BDU_ONREAD                 (0x1 << 7)
#   define CTRL_REG4_BLE_LSB_DFLT               (0x0 << 6)
#   define CTRL_REG4_BLE_MSB                    (0x0 << 6)
#   define CTRL_REG4_FS_100G_DFLT               (0x0 << 4)
#   define CTRL_REG4_FS_200G                    (0x1 << 4)
#   define CTRL_REG4_FS_400G                    (0x3 << 4)
#   define CTRL_REG4_SIM_4WIRE_DFLT             (0x0 << 0)
#   define CTRL_REG4_SIM_3WIRE                  (0x1 << 0)
#define CTRL_REG5                                     0x24
#   define CTRL_REG5_TURNON_DISABLED_DFLT       (0x0 << 0)
#   define CTRL_REG5_TURNON_ENABLED             (0x3 << 0)
#define HP_FILTER_RESET                               0x25
#define REFERENCE                                     0x26
#   define REFERENCE_REF_DFLT                   (0x0 << 0)
#   define REFERENCE_REF_FILTEROUTPUT           (0x1 << 0)
#define STATUS_REG                                    0x27
#   define STATUS_REG_ZXYOR_NOOVERRUN_DFLT      (0x0 << 7)
#   define STATUS_REG_ZXYOR_OVERRUN             (0x1 << 7)
#   define STATUS_REG_ZOR_NOOVERRUN_DFLT        (0x0 << 6)
#   define STATUS_REG_ZOR_OVERRUN               (0x1 << 6)
#   define STATUS_REG_YOR_NOOVERRUN_DFLT        (0x0 << 5)
#   define STATUS_REG_YOR_OVERRUN               (0x1 << 5)
#   define STATUS_REG_XOR_NOOVERRUN_DFLT        (0x0 << 4)
#   define STATUS_REG_XOR_OVERRUN               (0x1 << 4)
#   define STATUS_REG_ZYXDA_NODATA_DFLT         (0x0 << 3)
#   define STATUS_REG_ZYXDA_DRDY                (0x1 << 3)
#   define STATUS_REG_ZDA_NODATA_DFLT           (0x0 << 2)
#   define STATUS_REG_ZDA_DRDY                  (0x1 << 2)
#   define STATUS_REG_YDA_NODATA_DFLT           (0x0 << 1)
#   define STATUS_REG_YDA_DRDY                  (0x1 << 1)
#   define STATUS_REG_XDA_NODATA_DFLT           (0x0 << 0)
#   define STATUS_REG_XDA_DRDY                  (0x1 << 0)
#define OUT_X_L                                       0x28
#define OUT_X_H                                       0x29
#define OUT_Y_L                                       0x2A
#define OUT_Y_H                                       0x2B
...
#   define INT1_CFG_AOI_OR_INTEVENTS_DFLT       (0x0 << 7)
#   define INT1_CFG_AOI_AND_INTEVENTS           (0x1 << 7)
#   define INT1_CFG_ZHIE_DISABLE_DFLT           (0x0 << 5)
#   define INT1_CFG_ZHIE_ENABLE                 (0x1 << 5)
#   define INT1_CFG_ZLIE_DISABLE_DFLT           (0x0 << 4)
#   define INT1_CFG_ZLIE_ENABLE                 (0x1 << 4)
#   define INT1_CFG_YHIE_DISABLE_DFLT           (0x0 << 3)
#   define INT1_CFG_YHIE_ENABLE                 (0x1 << 3)
#   define INT1_CFG_YLIE_DISABLE_DFLT           (0x0 << 2)
#   define INT1_CFG_YLIE_ENABLE                 (0x1 << 2)
#   define INT1_CFG_XHIE_DISABLE_DFLT           (0x0 << 1)
#   define INT1_CFG_XHIE_ENABLE                 (0x1 << 1)
#   define INT1_CFG_XLIE_DISABLE_DFLT           (0x0 << 0)
#   define INT1_CFG_XLIE_ENABLE                 (0x1 << 0)
#define INT1_SRC                                      0x31
#   define INT1_SRC_IA_NOINT_DFLT               (0x0 << 6)
#   define INT1_SRC_IA_PRESENT                  (0x1 << 6)
#   define INT1_SRC_ZH_NOINT_DFLT               (0x0 << 5)
#   define INT1_SRC_ZH_PRESENT                  (0x1 << 5)
#   define INT1_SRC_ZL_NOINT_DFLT               (0x0 << 4)
#   define INT1_SRC_ZL_PRESENT                  (0x1 << 4)
#   define INT1_SRC_YH_NOINT_DFLT               (0x0 << 3)
#   define INT1_SRC_YH_PRESENT                  (0x1 << 3)
#   define INT1_SRC_YL_NOINT_DFLT               (0x0 << 2)
#   define INT1_SRC_YL_PRESENT                  (0x1 << 2)
#   define INT1_SRC_XH_NOINT_DFLT               (0x0 << 1)
#   define INT1_SRC_XH_PRESENT                  (0x1 << 1)
#   define INT1_SRC_XL_NOINT_DFLT               (0x0 << 0)
#   define INT1_SRC_XL_PRESENT                  (0x1 << 0)
#define INT1_THS                                      0x32
#   define INT1_THS_THS6_THRESHOLD_DFLT         (0x0 << 6)
#   define INT1_THS_THS5_THRESHOLD_DFLT         (0x0 << 5)
#   define INT1_THS_THS4_THRESHOLD_DFLT         (0x0 << 4)
#   define INT1_THS_THS3_THRESHOLD_DFLT         (0x0 << 3)
#   define INT1_THS_THS2_THRESHOLD_DFLT         (0x0 << 2)
#   define INT1_THS_THS1_THRESHOLD_DFLT         (0x0 << 1)
#   define INT1_THS_THS0_THRESHOLD_DFLT         (0x0 << 0)
#define INT1_DURATION                                 0x33
#   define INT1_DURATION_D6_DFLT                (0x0 << 6)
#   define INT1_DURATION_D5_DFLT                (0x0 << 5)
#   define INT1_DURATION_D4_DFLT                (0x0 << 4)
#   define INT1_DURATION_D3_DFLT                (0x0 << 3)
#   define INT1_DURATION_D2_DFLT                (0x0 << 2)
#   define INT1_DURATION_D1_DFLT                (0x0 << 1)
#   define INT1_DURATION_D0_DFLT                (0x0 << 0)
#define INT2_CFG                                      0x34
#   define INT2_CFG_AOI_OR_INTEVENTS_DFLT       (0x0 << 7)
#   define INT2_CFG_AOI_AND_INTEVENTS           (0x1 << 7)
#   define INT2_CFG_ZHIE_DISABLE_DFLT           (0x0 << 5)
#   define INT2_CFG_ZHIE_ENABLE                 (0x1 << 5)
#   define INT2_CFG_ZLIE_DISABLE_DFLT           (0x0 << 4)
#   define INT2_CFG_ZLIE_ENABLE                 (0x1 << 4)
#   define INT2_CFG_YHIE_DISABLE_DFLT           (0x0 << 3)
#   define INT2_CFG_YHIE_ENABLE                 (0x1 << 3)
#   define INT2_CFG_YLIE_DISABLE_DFLT           (0x0 << 2)
#   define INT2_CFG_YLIE_ENABLE                 (0x1 << 2)
#   define INT2_CFG_XHIE_DISABLE_DFLT           (0x0 << 1)
#   define INT2_CFG_XHIE_ENABLE                 (0x1 << 1)
#   define INT2_CFG_XLIE_DISABLE_DFLT           (0x0 << 0)
#   define INT2_CFG_XLIE_ENABLE                 (0x1 << 0)
#define INT2_SRC                                      0x35
#   define INT2_SRC_IA_NOINT_DFLT               (0x0 << 6)
#   define INT2_SRC_IA_PRESENT                  (0x1 << 6)
#   define INT2_SRC_ZH_NOINT_DFLT               (0x0 << 5)
#   define INT2_SRC_ZH_PRESENT                  (0x1 << 5)
#   define INT2_SRC_ZL_NOINT_DFLT               (0x0 << 4)
#   define INT2_SRC_ZL_PRESENT                  (0x1 << 4)
#   define INT2_SRC_YH_NOINT_DFLT               (0x0 << 3)
#   define INT2_SRC_YH_PRESENT                  (0x1 << 3)
#   define INT2_SRC_YL_NOINT_DFLT               (0x0 << 2)
#   define INT2_SRC_YL_PRESENT                  (0x1 << 2)
#   define INT2_SRC_XH_NOINT_DFLT               (0x0 << 1)
#   define INT2_SRC_XH_PRESENT                  (0x1 << 1)
#   define INT2_SRC_XL_NOINT_DFLT               (0x0 << 0)
#   define INT2_SRC_XL_PRESENT                  (0x1 << 0)
#define INT2_THS                                     0x36
#   define INT2_THS_THS6_THRESHOLD_DFLT         (0x0 << 6)
#   define INT2_THS_THS5_THRESHOLD_DFLT         (0x0 << 5)
#   define INT2_THS_THS4_THRESHOLD_DFLT         (0x0 << 4)
#   define INT2_THS_THS3_THRESHOLD_DFLT         (0x0 << 3)
#   define INT2_THS_THS2_THRESHOLD_DFLT         (0x0 << 2)
#   define INT2_THS_THS1_THRESHOLD_DFLT         (0x0 << 1)
#   define INT2_THS_THS0_THRESHOLD_DFLT         (0x0 << 0)
#define INT2_DURATION                                 0x37
#   define INT2_DURATION_D6_DFLT                (0x0 << 6)
#   define INT2_DURATION_D5_DFLT                (0x0 << 5)
#   define INT2_DURATION_D4_DFLT                (0x0 << 4)
#   define INT2_DURATION_D3_DFLT                (0x0 << 3)
#   define INT2_DURATION_D2_DFLT                (0x0 << 2)
#   define INT2_DURATION_D1_DFLT                (0x0 << 1)
#   define INT2_DURATION_D0_DFLT                (0x0 << 0)
...
// constructor
AP_InertialSensor_H3LIS331DL::AP_InertialSensor_H3LIS331DL(AP_InertialSensor &imu,
...
AP_InertialSensor_H3LIS331DL::~AP_InertialSensor_H3LIS331DL()
{
}
...
/*
  detect the sensor
 */
AP_InertialSensor_Backend *AP_InertialSensor_H3LIS331DL::probe(AP_InertialSensor &imu,
                                                             AP_HAL::OwnPtr<AP_HAL::I2CDevice> dev)
{
    if (!dev) {
        return nullptr;
    }
    AP_InertialSensor_H3LIS331DL *sensor
        = new AP_InertialSensor_H3LIS331DL(imu, std::move(dev));
...
bool AP_InertialSensor_H3LIS331DL::_init_sensor(void)
{
